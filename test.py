...
try:
    ...
    while True:
        ...
        if (stock_open_price and stock_high_low_price):
            ...
            print(call_prediction(float(stock_open_new_price), stock_high_price, stock_low_price, stock_volume))
        else:
